...
##################################
PROJECT_NAME: str = "Dark Face"
PROJECT_NAME_FULL: str = "Dark Face: Face Detection in Low Light Condition"
...
RELEASE_DATE: Optional[str] = "2019-03-15"  # e.g. "YYYY-MM-DD"
if RELEASE_DATE is None:
    RELEASE_YEAR: int = None

HOMEPAGE_URL: str = "https://flyywh.github.io/CVPRW2019LowLight/"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 8049345
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/dark-face"
...
PAPER: Optional[Union[str, List[str], Dict[str, str]]] = ["https://arxiv.org/abs/1808.04560", "https://ieeexplore.ieee.org/abstract/document/9049390"]
...
ORGANIZATION_URL: Optional[Union[str, List[str]]] = ["https://www.pku.edu.cn/"]
